...
public class JobApplicantMarksRequest {
    ...
    public JobApplicantMarksRequest() {
    }

    public JobApplicantMarksRequest(Long id, Timestamp timestamp, Long totalMarks, Long obtainedMarks) {
        this.id = id;
